...
typedef struct {
  ...
  int y;	                 
	...
	swigFunction( "c-function XLoadQueryFont XLoadQueryFont a a -- a", "FUNCTION: XLoadQueryFont (   -- a )", "EXTERN: \"C\" void * XLoadQueryFont( void * , char *  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XQueryFont XQueryFont a u -- a", "FUNCTION: XQueryFont (   -- a )", "EXTERN: \"C\" void * XQueryFont( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XGetMotionEvents XGetMotionEvents a u u u a -- a", "FUNCTION: XGetMotionEvents (      -- a )", "EXTERN: \"C\" void * XGetMotionEvents( void * , long , long , long , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XGetImage XGetImage a u n n u u u n -- a", "FUNCTION: XGetImage (         -- a )", "EXTERN: \"C\" void * XGetImage( void * , long , int , int , int , int , long , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetSubImage XGetSubImage a u n n u u u n a n n -- a", "FUNCTION: XGetSubImage (            -- a )", "EXTERN: \"C\" void * XGetSubImage( void * , long , int , int , int , int , long , int , void * , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XOpenDisplay XOpenDisplay a -- a", "FUNCTION: XOpenDisplay (  -- a )", "EXTERN: \"C\" void * XOpenDisplay( char *  );", "	( <noname> -- )" );
	...
	swigFunction( "c-function XGetDefault XGetDefault a a a -- a", "FUNCTION: XGetDefault (    -- a )", "EXTERN: \"C\" void * XGetDefault( void * , char * , char *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDisplayName XDisplayName a -- a", "FUNCTION: XDisplayName (  -- a )", "EXTERN: \"C\" void * XDisplayName( char *  );", "	( <noname> -- )" );
	swigFunction( "c-function XKeysymToString XKeysymToString u -- a", "FUNCTION: XKeysymToString (  -- a )", "EXTERN: \"C\" void * XKeysymToString( long  );", "	( <noname> -- )" );
	...
	swigFunction( "c-function XInternAtom XInternAtom a a n -- u", "FUNCTION: XInternAtom (    -- u )", "EXTERN: \"C\" long XInternAtom( void * , char * , int  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XCopyColormapAndFree XCopyColormapAndFree a u -- u", "FUNCTION: XCopyColormapAndFree (   -- u )", "EXTERN: \"C\" long XCopyColormapAndFree( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XCreateColormap XCreateColormap a u a n -- u", "FUNCTION: XCreateColormap (     -- u )", "EXTERN: \"C\" long XCreateColormap( void * , long , void * , int  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XCreatePixmapCursor XCreatePixmapCursor a u u a a u u -- u", "FUNCTION: XCreatePixmapCursor (        -- u )", "EXTERN: \"C\" long XCreatePixmapCursor( void * , long , long , void * , void * , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XCreateGlyphCursor XCreateGlyphCursor a u u u u a a -- u", "FUNCTION: XCreateGlyphCursor (        -- u )", "EXTERN: \"C\" long XCreateGlyphCursor( void * , long , long , int , int , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XCreateFontCursor XCreateFontCursor a u -- u", "FUNCTION: XCreateFontCursor (   -- u )", "EXTERN: \"C\" long XCreateFontCursor( void * , int  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XLoadFont XLoadFont a a -- u", "FUNCTION: XLoadFont (   -- u )", "EXTERN: \"C\" long XLoadFont( void * , char *  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XCreateGC XCreateGC a u u a -- a", "FUNCTION: XCreateGC (     -- a )", "EXTERN: \"C\" void * XCreateGC( void * , long , long , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGContextFromGC XGContextFromGC a -- u", "FUNCTION: XGContextFromGC (  -- u )", "EXTERN: \"C\" long XGContextFromGC( void *  );", "	( <noname> -- )" );
	swigFunction( "c-function XFlushGC XFlushGC a a -- void", "FUNCTION: XFlushGC (   -- void )", "EXTERN: \"C\" void XFlushGC( void * , void *  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XCreatePixmap XCreatePixmap a u u u u -- u", "FUNCTION: XCreatePixmap (      -- u )", "EXTERN: \"C\" long XCreatePixmap( void * , long , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XCreateBitmapFromData XCreateBitmapFromData a u a u u -- u", "FUNCTION: XCreateBitmapFromData (      -- u )", "EXTERN: \"C\" long XCreateBitmapFromData( void * , long , char * , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XCreatePixmapFromBitmapData XCreatePixmapFromBitmapData a u a u u u u u -- u", "FUNCTION: XCreatePixmapFromBitmapData (         -- u )", "EXTERN: \"C\" long XCreatePixmapFromBitmapData( void * , long , void * , int , int , long , long , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XCreateSimpleWindow XCreateSimpleWindow a u n n u u u u u -- u", "FUNCTION: XCreateSimpleWindow (          -- u )", "EXTERN: \"C\" long XCreateSimpleWindow( void * , long , int , int , int , int , int , long , long  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetSelectionOwner XGetSelectionOwner a u -- u", "FUNCTION: XGetSelectionOwner (   -- u )", "EXTERN: \"C\" long XGetSelectionOwner( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XCreateWindow XCreateWindow a u n n u u u n u a u a -- u", "FUNCTION: XCreateWindow (             -- u )", "EXTERN: \"C\" long XCreateWindow( void * , long , int , int , int , int , int , int , int , void * , long , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XListInstalledColormaps XListInstalledColormaps a u a -- a", "FUNCTION: XListInstalledColormaps (    -- a )", "EXTERN: \"C\" void * XListInstalledColormaps( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XListFonts XListFonts a a n a -- a", "FUNCTION: XListFonts (     -- a )", "EXTERN: \"C\" void * XListFonts( void * , char * , int , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XListFontsWithInfo XListFontsWithInfo a a n a a -- a", "FUNCTION: XListFontsWithInfo (      -- a )", "EXTERN: \"C\" void * XListFontsWithInfo( void * , char * , int , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XListProperties XListProperties a u a -- a", "FUNCTION: XListProperties (    -- a )", "EXTERN: \"C\" void * XListProperties( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XKeycodeToKeysym XKeycodeToKeysym a u n -- u", "FUNCTION: XKeycodeToKeysym (    -- u )", "EXTERN: \"C\" long XKeycodeToKeysym( void * , char , int  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XLookupKeysym XLookupKeysym a n -- u", "FUNCTION: XLookupKeysym (   -- u )", "EXTERN: \"C\" long XLookupKeysym( void * , int  );", "	( <noname> <noname> -- )" );
	...
	swigFunction( "c-function XStringToKeysym XStringToKeysym a -- u", "FUNCTION: XStringToKeysym (  -- u )", "EXTERN: \"C\" long XStringToKeysym( char *  );", "	( <noname> -- )" );
	...
	swigFunction( "c-function XInitExtension XInitExtension a a -- a", "FUNCTION: XInitExtension (   -- a )", "EXTERN: \"C\" void * XInitExtension( void * , char *  );", "	( <noname> <noname> -- )" );
	...
	swigFunction( "c-function XRootWindow XRootWindow a n -- u", "FUNCTION: XRootWindow (   -- u )", "EXTERN: \"C\" long XRootWindow( void * , int  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XDefaultRootWindow XDefaultRootWindow a -- u", "FUNCTION: XDefaultRootWindow (  -- u )", "EXTERN: \"C\" long XDefaultRootWindow( void *  );", "	( <noname> -- )" );
	swigFunction( "c-function XRootWindowOfScreen XRootWindowOfScreen a -- u", "FUNCTION: XRootWindowOfScreen (  -- u )", "EXTERN: \"C\" long XRootWindowOfScreen( void *  );", "	( <noname> -- )" );
	...
	swigFunction( "c-function XDefaultColormap XDefaultColormap a n -- u", "FUNCTION: XDefaultColormap (   -- u )", "EXTERN: \"C\" long XDefaultColormap( void * , int  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XDefaultColormapOfScreen XDefaultColormapOfScreen a -- u", "FUNCTION: XDefaultColormapOfScreen (  -- u )", "EXTERN: \"C\" long XDefaultColormapOfScreen( void *  );", "	( <noname> -- )" );
	...
	swigFunction( "c-function XReconfigureWMWindow XReconfigureWMWindow a u n u a -- n", "FUNCTION: XReconfigureWMWindow (      -- n )", "EXTERN: \"C\" int XReconfigureWMWindow( void * , long , int , int , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetWMProtocols XGetWMProtocols a u a a -- n", "FUNCTION: XGetWMProtocols (     -- n )", "EXTERN: \"C\" int XGetWMProtocols( void * , long , void * , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWMProtocols XSetWMProtocols a u a n -- n", "FUNCTION: XSetWMProtocols (     -- n )", "EXTERN: \"C\" int XSetWMProtocols( void * , long , void * , int  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XIconifyWindow XIconifyWindow a u n -- n", "FUNCTION: XIconifyWindow (    -- n )", "EXTERN: \"C\" int XIconifyWindow( void * , long , int  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XWithdrawWindow XWithdrawWindow a u n -- n", "FUNCTION: XWithdrawWindow (    -- n )", "EXTERN: \"C\" int XWithdrawWindow( void * , long , int  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetCommand XGetCommand a u a a -- n", "FUNCTION: XGetCommand (     -- n )", "EXTERN: \"C\" int XGetCommand( void * , long , void * , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetWMColormapWindows XGetWMColormapWindows a u a a -- n", "FUNCTION: XGetWMColormapWindows (     -- n )", "EXTERN: \"C\" int XGetWMColormapWindows( void * , long , void * , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWMColormapWindows XSetWMColormapWindows a u a n -- n", "FUNCTION: XSetWMColormapWindows (     -- n )", "EXTERN: \"C\" int XSetWMColormapWindows( void * , long , void * , int  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSetTransientForHint XSetTransientForHint a u u -- n", "FUNCTION: XSetTransientForHint (    -- n )", "EXTERN: \"C\" int XSetTransientForHint( void * , long , long  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XAddToSaveSet XAddToSaveSet a u -- n", "FUNCTION: XAddToSaveSet (   -- n )", "EXTERN: \"C\" int XAddToSaveSet( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XAllocColor XAllocColor a u a -- n", "FUNCTION: XAllocColor (    -- n )", "EXTERN: \"C\" int XAllocColor( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XAllocColorCells XAllocColorCells a u n a u a u -- n", "FUNCTION: XAllocColorCells (        -- n )", "EXTERN: \"C\" int XAllocColorCells( void * , long , int , void * , int , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XAllocColorPlanes XAllocColorPlanes a u n a n n n n a a a -- n", "FUNCTION: XAllocColorPlanes (            -- n )", "EXTERN: \"C\" int XAllocColorPlanes( void * , long , int , void * , int , int , int , int , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XAllocNamedColor XAllocNamedColor a u a a a -- n", "FUNCTION: XAllocNamedColor (      -- n )", "EXTERN: \"C\" int XAllocNamedColor( void * , long , char * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XChangeActivePointerGrab XChangeActivePointerGrab a u u u -- n", "FUNCTION: XChangeActivePointerGrab (     -- n )", "EXTERN: \"C\" int XChangeActivePointerGrab( void * , int , long , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XChangeProperty XChangeProperty a u u u n n a n -- n", "FUNCTION: XChangeProperty (         -- n )", "EXTERN: \"C\" int XChangeProperty( void * , long , long , long , int , int , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XChangeSaveSet XChangeSaveSet a u n -- n", "FUNCTION: XChangeSaveSet (    -- n )", "EXTERN: \"C\" int XChangeSaveSet( void * , long , int  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XChangeWindowAttributes XChangeWindowAttributes a u u a -- n", "FUNCTION: XChangeWindowAttributes (     -- n )", "EXTERN: \"C\" int XChangeWindowAttributes( void * , long , long , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XCheckTypedWindowEvent XCheckTypedWindowEvent a u n a -- n", "FUNCTION: XCheckTypedWindowEvent (     -- n )", "EXTERN: \"C\" int XCheckTypedWindowEvent( void * , long , int , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XCheckWindowEvent XCheckWindowEvent a u n a -- n", "FUNCTION: XCheckWindowEvent (     -- n )", "EXTERN: \"C\" int XCheckWindowEvent( void * , long , long , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XCirculateSubwindows XCirculateSubwindows a u n -- n", "FUNCTION: XCirculateSubwindows (    -- n )", "EXTERN: \"C\" int XCirculateSubwindows( void * , long , int  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XCirculateSubwindowsDown XCirculateSubwindowsDown a u -- n", "FUNCTION: XCirculateSubwindowsDown (   -- n )", "EXTERN: \"C\" int XCirculateSubwindowsDown( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XCirculateSubwindowsUp XCirculateSubwindowsUp a u -- n", "FUNCTION: XCirculateSubwindowsUp (   -- n )", "EXTERN: \"C\" int XCirculateSubwindowsUp( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XClearArea XClearArea a u n n u u n -- n", "FUNCTION: XClearArea (        -- n )", "EXTERN: \"C\" int XClearArea( void * , long , int , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XClearWindow XClearWindow a u -- n", "FUNCTION: XClearWindow (   -- n )", "EXTERN: \"C\" int XClearWindow( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XCloseDisplay XCloseDisplay a -- n", "FUNCTION: XCloseDisplay (  -- n )", "EXTERN: \"C\" int XCloseDisplay( void *  );", "	( <noname> -- )" );
	swigFunction( "c-function XConfigureWindow XConfigureWindow a u u a -- n", "FUNCTION: XConfigureWindow (     -- n )", "EXTERN: \"C\" int XConfigureWindow( void * , long , int , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XConvertSelection XConvertSelection a u u u u u -- n", "FUNCTION: XConvertSelection (       -- n )", "EXTERN: \"C\" int XConvertSelection( void * , long , long , long , long , long  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XCopyArea XCopyArea a u u a n n u u n n -- n", "FUNCTION: XCopyArea (           -- n )", "EXTERN: \"C\" int XCopyArea( void * , long , long , void * , int , int , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XCopyPlane XCopyPlane a u u a n n u u n n u -- n", "FUNCTION: XCopyPlane (            -- n )", "EXTERN: \"C\" int XCopyPlane( void * , long , long , void * , int , int , int , int , int , int , long  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XDefineCursor XDefineCursor a u u -- n", "FUNCTION: XDefineCursor (    -- n )", "EXTERN: \"C\" int XDefineCursor( void * , long , long  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDeleteProperty XDeleteProperty a u u -- n", "FUNCTION: XDeleteProperty (    -- n )", "EXTERN: \"C\" int XDeleteProperty( void * , long , long  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDestroyWindow XDestroyWindow a u -- n", "FUNCTION: XDestroyWindow (   -- n )", "EXTERN: \"C\" int XDestroyWindow( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XDestroySubwindows XDestroySubwindows a u -- n", "FUNCTION: XDestroySubwindows (   -- n )", "EXTERN: \"C\" int XDestroySubwindows( void * , long  );", "	( <noname> <noname> -- )" );
	...
	swigFunction( "c-function XDrawArc XDrawArc a u a n n u u n n -- n", "FUNCTION: XDrawArc (          -- n )", "EXTERN: \"C\" int XDrawArc( void * , long , void * , int , int , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawArcs XDrawArcs a u a a n -- n", "FUNCTION: XDrawArcs (      -- n )", "EXTERN: \"C\" int XDrawArcs( void * , long , void * , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawImageString XDrawImageString a u a n n a n -- n", "FUNCTION: XDrawImageString (        -- n )", "EXTERN: \"C\" int XDrawImageString( void * , long , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawImageString16 XDrawImageString16 a u a n n a n -- n", "FUNCTION: XDrawImageString16 (        -- n )", "EXTERN: \"C\" int XDrawImageString16( void * , long , void * , int , int , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawLine XDrawLine a u a n n n n -- n", "FUNCTION: XDrawLine (        -- n )", "EXTERN: \"C\" int XDrawLine( void * , long , void * , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawLines XDrawLines a u a a n n -- n", "FUNCTION: XDrawLines (       -- n )", "EXTERN: \"C\" int XDrawLines( void * , long , void * , void * , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawPoint XDrawPoint a u a n n -- n", "FUNCTION: XDrawPoint (      -- n )", "EXTERN: \"C\" int XDrawPoint( void * , long , void * , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawPoints XDrawPoints a u a a n n -- n", "FUNCTION: XDrawPoints (       -- n )", "EXTERN: \"C\" int XDrawPoints( void * , long , void * , void * , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawRectangle XDrawRectangle a u a n n u u -- n", "FUNCTION: XDrawRectangle (        -- n )", "EXTERN: \"C\" int XDrawRectangle( void * , long , void * , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawRectangles XDrawRectangles a u a a n -- n", "FUNCTION: XDrawRectangles (      -- n )", "EXTERN: \"C\" int XDrawRectangles( void * , long , void * , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawSegments XDrawSegments a u a a n -- n", "FUNCTION: XDrawSegments (      -- n )", "EXTERN: \"C\" int XDrawSegments( void * , long , void * , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawString XDrawString a u a n n a n -- n", "FUNCTION: XDrawString (        -- n )", "EXTERN: \"C\" int XDrawString( void * , long , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawString16 XDrawString16 a u a n n a n -- n", "FUNCTION: XDrawString16 (        -- n )", "EXTERN: \"C\" int XDrawString16( void * , long , void * , int , int , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawText XDrawText a u a n n a n -- n", "FUNCTION: XDrawText (        -- n )", "EXTERN: \"C\" int XDrawText( void * , long , void * , int , int , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XDrawText16 XDrawText16 a u a n n a n -- n", "FUNCTION: XDrawText16 (        -- n )", "EXTERN: \"C\" int XDrawText16( void * , long , void * , int , int , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XFetchName XFetchName a u a -- n", "FUNCTION: XFetchName (    -- n )", "EXTERN: \"C\" int XFetchName( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XFillArc XFillArc a u a n n u u n n -- n", "FUNCTION: XFillArc (          -- n )", "EXTERN: \"C\" int XFillArc( void * , long , void * , int , int , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XFillArcs XFillArcs a u a a n -- n", "FUNCTION: XFillArcs (      -- n )", "EXTERN: \"C\" int XFillArcs( void * , long , void * , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XFillPolygon XFillPolygon a u a a n n n -- n", "FUNCTION: XFillPolygon (        -- n )", "EXTERN: \"C\" int XFillPolygon( void * , long , void * , void * , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XFillRectangle XFillRectangle a u a n n u u -- n", "FUNCTION: XFillRectangle (        -- n )", "EXTERN: \"C\" int XFillRectangle( void * , long , void * , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XFillRectangles XFillRectangles a u a a n -- n", "FUNCTION: XFillRectangles (      -- n )", "EXTERN: \"C\" int XFillRectangles( void * , long , void * , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XFreeColormap XFreeColormap a u -- n", "FUNCTION: XFreeColormap (   -- n )", "EXTERN: \"C\" int XFreeColormap( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XFreeColors XFreeColors a u a n u -- n", "FUNCTION: XFreeColors (      -- n )", "EXTERN: \"C\" int XFreeColors( void * , long , void * , int , long  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XFreeCursor XFreeCursor a u -- n", "FUNCTION: XFreeCursor (   -- n )", "EXTERN: \"C\" int XFreeCursor( void * , long  );", "	( <noname> <noname> -- )" );
	...
	swigFunction( "c-function XFreePixmap XFreePixmap a u -- n", "FUNCTION: XFreePixmap (   -- n )", "EXTERN: \"C\" int XFreePixmap( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XGeometry XGeometry a n a a u u u n n a a a a -- n", "FUNCTION: XGeometry (              -- n )", "EXTERN: \"C\" int XGeometry( void * , int , char * , char * , int , int , int , int , int , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetErrorDatabaseText XGetErrorDatabaseText a a a a a n -- n", "FUNCTION: XGetErrorDatabaseText (       -- n )", "EXTERN: \"C\" int XGetErrorDatabaseText( void * , char * , char * , char * , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XGetGeometry XGetGeometry a u a a a a a a a -- n", "FUNCTION: XGetGeometry (          -- n )", "EXTERN: \"C\" int XGetGeometry( void * , long , void * , void * , void * , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetIconName XGetIconName a u a -- n", "FUNCTION: XGetIconName (    -- n )", "EXTERN: \"C\" int XGetIconName( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XGetTransientForHint XGetTransientForHint a u a -- n", "FUNCTION: XGetTransientForHint (    -- n )", "EXTERN: \"C\" int XGetTransientForHint( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetWindowProperty XGetWindowProperty a u u n n n u a a a a a -- n", "FUNCTION: XGetWindowProperty (             -- n )", "EXTERN: \"C\" int XGetWindowProperty( void * , long , long , long , long , int , long , void * , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetWindowAttributes XGetWindowAttributes a u a -- n", "FUNCTION: XGetWindowAttributes (    -- n )", "EXTERN: \"C\" int XGetWindowAttributes( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGrabButton XGrabButton a u u u n u n n u u -- n", "FUNCTION: XGrabButton (           -- n )", "EXTERN: \"C\" int XGrabButton( void * , int , int , long , int , int , int , int , long , long  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGrabKey XGrabKey a n u u n n n -- n", "FUNCTION: XGrabKey (        -- n )", "EXTERN: \"C\" int XGrabKey( void * , int , int , long , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGrabKeyboard XGrabKeyboard a u n n n u -- n", "FUNCTION: XGrabKeyboard (       -- n )", "EXTERN: \"C\" int XGrabKeyboard( void * , long , int , int , int , long  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGrabPointer XGrabPointer a u n u n n u u u -- n", "FUNCTION: XGrabPointer (          -- n )", "EXTERN: \"C\" int XGrabPointer( void * , long , int , int , int , int , long , long , long  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XInstallColormap XInstallColormap a u -- n", "FUNCTION: XInstallColormap (   -- n )", "EXTERN: \"C\" int XInstallColormap( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XKeysymToKeycode XKeysymToKeycode a u -- u", "FUNCTION: XKeysymToKeycode (   -- u )", "EXTERN: \"C\" char XKeysymToKeycode( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XKillClient XKillClient a u -- n", "FUNCTION: XKillClient (   -- n )", "EXTERN: \"C\" int XKillClient( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XLookupColor XLookupColor a u a a a -- n", "FUNCTION: XLookupColor (      -- n )", "EXTERN: \"C\" int XLookupColor( void * , long , char * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XLowerWindow XLowerWindow a u -- n", "FUNCTION: XLowerWindow (   -- n )", "EXTERN: \"C\" int XLowerWindow( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XMapRaised XMapRaised a u -- n", "FUNCTION: XMapRaised (   -- n )", "EXTERN: \"C\" int XMapRaised( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XMapSubwindows XMapSubwindows a u -- n", "FUNCTION: XMapSubwindows (   -- n )", "EXTERN: \"C\" int XMapSubwindows( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XMapWindow XMapWindow a u -- n", "FUNCTION: XMapWindow (   -- n )", "EXTERN: \"C\" int XMapWindow( void * , long  );", "	( <noname> <noname> -- )" );
	...
	swigFunction( "c-function XMoveResizeWindow XMoveResizeWindow a u n n u u -- n", "FUNCTION: XMoveResizeWindow (       -- n )", "EXTERN: \"C\" int XMoveResizeWindow( void * , long , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XMoveWindow XMoveWindow a u n n -- n", "FUNCTION: XMoveWindow (     -- n )", "EXTERN: \"C\" int XMoveWindow( void * , long , int , int  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XParseColor XParseColor a u a a -- n", "FUNCTION: XParseColor (     -- n )", "EXTERN: \"C\" int XParseColor( void * , long , char * , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XParseGeometry XParseGeometry a a a a a -- n", "FUNCTION: XParseGeometry (      -- n )", "EXTERN: \"C\" int XParseGeometry( char * , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XPutImage XPutImage a u a a n n n n u u -- n", "FUNCTION: XPutImage (           -- n )", "EXTERN: \"C\" int XPutImage( void * , long , void * , void * , int , int , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XQLength XQLength a -- n", "FUNCTION: XQLength (  -- n )", "EXTERN: \"C\" int XQLength( void *  );", "	( <noname> -- )" );
	swigFunction( "c-function XQueryBestCursor XQueryBestCursor a u u u a a -- n", "FUNCTION: XQueryBestCursor (       -- n )", "EXTERN: \"C\" int XQueryBestCursor( void * , long , int , int , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XQueryBestSize XQueryBestSize a n u u u a a -- n", "FUNCTION: XQueryBestSize (        -- n )", "EXTERN: \"C\" int XQueryBestSize( void * , int , long , int , int , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XQueryBestStipple XQueryBestStipple a u u u a a -- n", "FUNCTION: XQueryBestStipple (       -- n )", "EXTERN: \"C\" int XQueryBestStipple( void * , long , int , int , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XQueryBestTile XQueryBestTile a u u u a a -- n", "FUNCTION: XQueryBestTile (       -- n )", "EXTERN: \"C\" int XQueryBestTile( void * , long , int , int , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XQueryColor XQueryColor a u a -- n", "FUNCTION: XQueryColor (    -- n )", "EXTERN: \"C\" int XQueryColor( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XQueryColors XQueryColors a u a n -- n", "FUNCTION: XQueryColors (     -- n )", "EXTERN: \"C\" int XQueryColors( void * , long , void * , int  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XQueryExtension XQueryExtension a a a a a -- n", "FUNCTION: XQueryExtension (      -- n )", "EXTERN: \"C\" int XQueryExtension( void * , char * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XQueryPointer XQueryPointer a u a a a a a a a -- n", "FUNCTION: XQueryPointer (          -- n )", "EXTERN: \"C\" int XQueryPointer( void * , long , void * , void * , void * , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XQueryTextExtents XQueryTextExtents a u a n a a a a -- n", "FUNCTION: XQueryTextExtents (         -- n )", "EXTERN: \"C\" int XQueryTextExtents( void * , long , char * , int , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XQueryTextExtents16 XQueryTextExtents16 a u a n a a a a -- n", "FUNCTION: XQueryTextExtents16 (         -- n )", "EXTERN: \"C\" int XQueryTextExtents16( void * , long , void * , int , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XQueryTree XQueryTree a u a a a a -- n", "FUNCTION: XQueryTree (       -- n )", "EXTERN: \"C\" int XQueryTree( void * , long , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XRaiseWindow XRaiseWindow a u -- n", "FUNCTION: XRaiseWindow (   -- n )", "EXTERN: \"C\" int XRaiseWindow( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XReadBitmapFile XReadBitmapFile a u a a a a a a -- n", "FUNCTION: XReadBitmapFile (         -- n )", "EXTERN: \"C\" int XReadBitmapFile( void * , long , char * , void * , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XReadBitmapFileData XReadBitmapFileData a a a a a a -- n", "FUNCTION: XReadBitmapFileData (       -- n )", "EXTERN: \"C\" int XReadBitmapFileData( char * , void * , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XRebindKeysym XRebindKeysym a u a n a n -- n", "FUNCTION: XRebindKeysym (       -- n )", "EXTERN: \"C\" int XRebindKeysym( void * , long , void * , int , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XRecolorCursor XRecolorCursor a u a a -- n", "FUNCTION: XRecolorCursor (     -- n )", "EXTERN: \"C\" int XRecolorCursor( void * , long , void * , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XRemoveFromSaveSet XRemoveFromSaveSet a u -- n", "FUNCTION: XRemoveFromSaveSet (   -- n )", "EXTERN: \"C\" int XRemoveFromSaveSet( void * , long  );", "	( <noname> <noname> -- )" );
	...
	swigFunction( "c-function XReparentWindow XReparentWindow a u u n n -- n", "FUNCTION: XReparentWindow (      -- n )", "EXTERN: \"C\" int XReparentWindow( void * , long , long , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XResizeWindow XResizeWindow a u u u -- n", "FUNCTION: XResizeWindow (     -- n )", "EXTERN: \"C\" int XResizeWindow( void * , long , int , int  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XRotateWindowProperties XRotateWindowProperties a u a n n -- n", "FUNCTION: XRotateWindowProperties (      -- n )", "EXTERN: \"C\" int XRotateWindowProperties( void * , long , void * , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XScreenCount XScreenCount a -- n", "FUNCTION: XScreenCount (  -- n )", "EXTERN: \"C\" int XScreenCount( void *  );", "	( <noname> -- )" );
	swigFunction( "c-function XSelectInput XSelectInput a u n -- n", "FUNCTION: XSelectInput (    -- n )", "EXTERN: \"C\" int XSelectInput( void * , long , long  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSendEvent XSendEvent a u n n a -- n", "FUNCTION: XSendEvent (      -- n )", "EXTERN: \"C\" int XSendEvent( void * , long , int , long , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSetClipMask XSetClipMask a a u -- n", "FUNCTION: XSetClipMask (    -- n )", "EXTERN: \"C\" int XSetClipMask( void * , void * , long  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSetCommand XSetCommand a u a n -- n", "FUNCTION: XSetCommand (     -- n )", "EXTERN: \"C\" int XSetCommand( void * , long , void * , int  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetDashes XSetDashes a a n a n -- n", "FUNCTION: XSetDashes (      -- n )", "EXTERN: \"C\" int XSetDashes( void * , void * , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSetFont XSetFont a a u -- n", "FUNCTION: XSetFont (    -- n )", "EXTERN: \"C\" int XSetFont( void * , void * , long  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSetIconName XSetIconName a u a -- n", "FUNCTION: XSetIconName (    -- n )", "EXTERN: \"C\" int XSetIconName( void * , long , char *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetInputFocus XSetInputFocus a u n u -- n", "FUNCTION: XSetInputFocus (     -- n )", "EXTERN: \"C\" int XSetInputFocus( void * , long , int , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSetSelectionOwner XSetSelectionOwner a u u u -- n", "FUNCTION: XSetSelectionOwner (     -- n )", "EXTERN: \"C\" int XSetSelectionOwner( void * , long , long , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSetStipple XSetStipple a a u -- n", "FUNCTION: XSetStipple (    -- n )", "EXTERN: \"C\" int XSetStipple( void * , void * , long  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSetTile XSetTile a a u -- n", "FUNCTION: XSetTile (    -- n )", "EXTERN: \"C\" int XSetTile( void * , void * , long  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWindowBackground XSetWindowBackground a u u -- n", "FUNCTION: XSetWindowBackground (    -- n )", "EXTERN: \"C\" int XSetWindowBackground( void * , long , long  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWindowBackgroundPixmap XSetWindowBackgroundPixmap a u u -- n", "FUNCTION: XSetWindowBackgroundPixmap (    -- n )", "EXTERN: \"C\" int XSetWindowBackgroundPixmap( void * , long , long  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWindowBorder XSetWindowBorder a u u -- n", "FUNCTION: XSetWindowBorder (    -- n )", "EXTERN: \"C\" int XSetWindowBorder( void * , long , long  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWindowBorderPixmap XSetWindowBorderPixmap a u u -- n", "FUNCTION: XSetWindowBorderPixmap (    -- n )", "EXTERN: \"C\" int XSetWindowBorderPixmap( void * , long , long  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWindowBorderWidth XSetWindowBorderWidth a u u -- n", "FUNCTION: XSetWindowBorderWidth (    -- n )", "EXTERN: \"C\" int XSetWindowBorderWidth( void * , long , int  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWindowColormap XSetWindowColormap a u u -- n", "FUNCTION: XSetWindowColormap (    -- n )", "EXTERN: \"C\" int XSetWindowColormap( void * , long , long  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XStoreBuffer XStoreBuffer a a n n -- n", "FUNCTION: XStoreBuffer (     -- n )", "EXTERN: \"C\" int XStoreBuffer( void * , char * , int , int  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XStoreBytes XStoreBytes a a n -- n", "FUNCTION: XStoreBytes (    -- n )", "EXTERN: \"C\" int XStoreBytes( void * , char * , int  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XStoreColor XStoreColor a u a -- n", "FUNCTION: XStoreColor (    -- n )", "EXTERN: \"C\" int XStoreColor( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XStoreColors XStoreColors a u a n -- n", "FUNCTION: XStoreColors (     -- n )", "EXTERN: \"C\" int XStoreColors( void * , long , void * , int  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XStoreName XStoreName a u a -- n", "FUNCTION: XStoreName (    -- n )", "EXTERN: \"C\" int XStoreName( void * , long , char *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XStoreNamedColor XStoreNamedColor a u a u n -- n", "FUNCTION: XStoreNamedColor (      -- n )", "EXTERN: \"C\" int XStoreNamedColor( void * , long , char * , long , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSync XSync a n -- n", "FUNCTION: XSync (   -- n )", "EXTERN: \"C\" int XSync( void * , int  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XTextExtents XTextExtents a a n a a a a -- n", "FUNCTION: XTextExtents (        -- n )", "EXTERN: \"C\" int XTextExtents( void * , char * , int , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XTextWidth XTextWidth a a n -- n", "FUNCTION: XTextWidth (    -- n )", "EXTERN: \"C\" int XTextWidth( void * , char * , int  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XTranslateCoordinates XTranslateCoordinates a u u n n a a a -- n", "FUNCTION: XTranslateCoordinates (         -- n )", "EXTERN: \"C\" int XTranslateCoordinates( void * , long , long , int , int , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XUndefineCursor XUndefineCursor a u -- n", "FUNCTION: XUndefineCursor (   -- n )", "EXTERN: \"C\" int XUndefineCursor( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XUngrabButton XUngrabButton a u u u -- n", "FUNCTION: XUngrabButton (     -- n )", "EXTERN: \"C\" int XUngrabButton( void * , int , int , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XUngrabKey XUngrabKey a n u u -- n", "FUNCTION: XUngrabKey (     -- n )", "EXTERN: \"C\" int XUngrabKey( void * , int , int , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XUninstallColormap XUninstallColormap a u -- n", "FUNCTION: XUninstallColormap (   -- n )", "EXTERN: \"C\" int XUninstallColormap( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XUnloadFont XUnloadFont a u -- n", "FUNCTION: XUnloadFont (   -- n )", "EXTERN: \"C\" int XUnloadFont( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XUnmapSubwindows XUnmapSubwindows a u -- n", "FUNCTION: XUnmapSubwindows (   -- n )", "EXTERN: \"C\" int XUnmapSubwindows( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XUnmapWindow XUnmapWindow a u -- n", "FUNCTION: XUnmapWindow (   -- n )", "EXTERN: \"C\" int XUnmapWindow( void * , long  );", "	( <noname> <noname> -- )" );
	...
	swigFunction( "c-function XWarpPointer XWarpPointer a u u n n u u n n -- n", "FUNCTION: XWarpPointer (          -- n )", "EXTERN: \"C\" int XWarpPointer( void * , long , long , int , int , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XWindowEvent XWindowEvent a u n a -- n", "FUNCTION: XWindowEvent (     -- n )", "EXTERN: \"C\" int XWindowEvent( void * , long , long , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XWriteBitmapFile XWriteBitmapFile a a u u u n n -- n", "FUNCTION: XWriteBitmapFile (        -- n )", "EXTERN: \"C\" int XWriteBitmapFile( void * , char * , long , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSupportsLocale XSupportsLocale  -- n", "FUNCTION: XSupportsLocale (  -- n )", "EXTERN: \"C\" int XSupportsLocale(  );", "	( -- )" );
	swigFunction( "c-function XSetLocaleModifiers XSetLocaleModifiers a -- a", "FUNCTION: XSetLocaleModifiers (  -- a )", "EXTERN: \"C\" void * XSetLocaleModifiers( char *  );", "	( <noname> -- )" );
	swigFunction( "c-function XOpenOM XOpenOM a a a a -- a", "FUNCTION: XOpenOM (     -- a )", "EXTERN: \"C\" void * XOpenOM( void * , void * , char * , char *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XCreateFontSet XCreateFontSet a a a a a -- a", "FUNCTION: XCreateFontSet (      -- a )", "EXTERN: \"C\" void * XCreateFontSet( void * , char * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XmbTextEscapement XmbTextEscapement a a n -- n", "FUNCTION: XmbTextEscapement (    -- n )", "EXTERN: \"C\" int XmbTextEscapement( void * , char * , int  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function Xutf8TextEscapement Xutf8TextEscapement a a n -- n", "FUNCTION: Xutf8TextEscapement (    -- n )", "EXTERN: \"C\" int Xutf8TextEscapement( void * , char * , int  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XmbTextExtents XmbTextExtents a a n a a -- n", "FUNCTION: XmbTextExtents (      -- n )", "EXTERN: \"C\" int XmbTextExtents( void * , char * , int , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function Xutf8TextExtents Xutf8TextExtents a a n a a -- n", "FUNCTION: Xutf8TextExtents (      -- n )", "EXTERN: \"C\" int Xutf8TextExtents( void * , char * , int , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XmbTextPerCharExtents XmbTextPerCharExtents a a n a a n a a a -- n", "FUNCTION: XmbTextPerCharExtents (          -- n )", "EXTERN: \"C\" int XmbTextPerCharExtents( void * , char * , int , void * , void * , int , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function Xutf8TextPerCharExtents Xutf8TextPerCharExtents a a n a a n a a a -- n", "FUNCTION: Xutf8TextPerCharExtents (          -- n )", "EXTERN: \"C\" int Xutf8TextPerCharExtents( void * , char * , int , void * , void * , int , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XmbDrawText XmbDrawText a u a n n a n -- void", "FUNCTION: XmbDrawText (        -- void )", "EXTERN: \"C\" void XmbDrawText( void * , long , void * , int , int , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XwcDrawText XwcDrawText a u a n n a n -- void", "FUNCTION: XwcDrawText (        -- void )", "EXTERN: \"C\" void XwcDrawText( void * , long , void * , int , int , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function Xutf8DrawText Xutf8DrawText a u a n n a n -- void", "FUNCTION: Xutf8DrawText (        -- void )", "EXTERN: \"C\" void Xutf8DrawText( void * , long , void * , int , int , void * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XmbDrawString XmbDrawString a u a a n n a n -- void", "FUNCTION: XmbDrawString (         -- void )", "EXTERN: \"C\" void XmbDrawString( void * , long , void * , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XwcDrawString XwcDrawString a u a a n n ws n -- void", "FUNCTION: XwcDrawString (         -- void )", "EXTERN: \"C\" void XwcDrawString( void * , long , void * , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function Xutf8DrawString Xutf8DrawString a u a a n n a n -- void", "FUNCTION: Xutf8DrawString (         -- void )", "EXTERN: \"C\" void Xutf8DrawString( void * , long , void * , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XmbDrawImageString XmbDrawImageString a u a a n n a n -- void", "FUNCTION: XmbDrawImageString (         -- void )", "EXTERN: \"C\" void XmbDrawImageString( void * , long , void * , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XwcDrawImageString XwcDrawImageString a u a a n n ws n -- void", "FUNCTION: XwcDrawImageString (         -- void )", "EXTERN: \"C\" void XwcDrawImageString( void * , long , void * , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function Xutf8DrawImageString Xutf8DrawImageString a u a a n n a n -- void", "FUNCTION: Xutf8DrawImageString (         -- void )", "EXTERN: \"C\" void Xutf8DrawImageString( void * , long , void * , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XFilterEvent XFilterEvent a u -- n", "FUNCTION: XFilterEvent (   -- n )", "EXTERN: \"C\" int XFilterEvent( void * , long  );", "	( <noname> <noname> -- )" );
	...
	swigFunction( "c-function XDefaultString XDefaultString  -- a", "FUNCTION: XDefaultString (  -- a )", "EXTERN: \"C\" char * XDefaultString(  );", "	( -- )" );
	swigFunction( "c-function XDeleteContext XDeleteContext a u n -- n", "FUNCTION: XDeleteContext (    -- n )", "EXTERN: \"C\" int XDeleteContext( void * , long , int  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XFindContext XFindContext a u n a -- n", "FUNCTION: XFindContext (     -- n )", "EXTERN: \"C\" int XFindContext( void * , long , int , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetClassHint XGetClassHint a u a -- n", "FUNCTION: XGetClassHint (    -- n )", "EXTERN: \"C\" int XGetClassHint( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetIconSizes XGetIconSizes a u a a -- n", "FUNCTION: XGetIconSizes (     -- n )", "EXTERN: \"C\" int XGetIconSizes( void * , long , void * , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetNormalHints XGetNormalHints a u a -- n", "FUNCTION: XGetNormalHints (    -- n )", "EXTERN: \"C\" int XGetNormalHints( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetRGBColormaps XGetRGBColormaps a u a a u -- n", "FUNCTION: XGetRGBColormaps (      -- n )", "EXTERN: \"C\" int XGetRGBColormaps( void * , long , void * , void * , long  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetSizeHints XGetSizeHints a u a u -- n", "FUNCTION: XGetSizeHints (     -- n )", "EXTERN: \"C\" int XGetSizeHints( void * , long , void * , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetStandardColormap XGetStandardColormap a u a u -- n", "FUNCTION: XGetStandardColormap (     -- n )", "EXTERN: \"C\" int XGetStandardColormap( void * , long , void * , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetTextProperty XGetTextProperty a u a u -- n", "FUNCTION: XGetTextProperty (     -- n )", "EXTERN: \"C\" int XGetTextProperty( void * , long , void * , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XGetWMClientMachine XGetWMClientMachine a u a -- n", "FUNCTION: XGetWMClientMachine (    -- n )", "EXTERN: \"C\" int XGetWMClientMachine( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetWMHints XGetWMHints a u -- a", "FUNCTION: XGetWMHints (   -- a )", "EXTERN: \"C\" void * XGetWMHints( void * , long  );", "	( <noname> <noname> -- )" );
	swigFunction( "c-function XGetWMIconName XGetWMIconName a u a -- n", "FUNCTION: XGetWMIconName (    -- n )", "EXTERN: \"C\" int XGetWMIconName( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetWMName XGetWMName a u a -- n", "FUNCTION: XGetWMName (    -- n )", "EXTERN: \"C\" int XGetWMName( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetWMNormalHints XGetWMNormalHints a u a a -- n", "FUNCTION: XGetWMNormalHints (     -- n )", "EXTERN: \"C\" int XGetWMNormalHints( void * , long , void * , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetWMSizeHints XGetWMSizeHints a u a a u -- n", "FUNCTION: XGetWMSizeHints (      -- n )", "EXTERN: \"C\" int XGetWMSizeHints( void * , long , void * , void * , long  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XGetZoomHints XGetZoomHints a u a -- n", "FUNCTION: XGetZoomHints (    -- n )", "EXTERN: \"C\" int XGetZoomHints( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XConvertCase XConvertCase u a a -- void", "FUNCTION: XConvertCase (    -- void )", "EXTERN: \"C\" void XConvertCase( long , void * , void *  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSaveContext XSaveContext a u n a -- n", "FUNCTION: XSaveContext (     -- n )", "EXTERN: \"C\" int XSaveContext( void * , long , int , char *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetClassHint XSetClassHint a u a -- n", "FUNCTION: XSetClassHint (    -- n )", "EXTERN: \"C\" int XSetClassHint( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetIconSizes XSetIconSizes a u a n -- n", "FUNCTION: XSetIconSizes (     -- n )", "EXTERN: \"C\" int XSetIconSizes( void * , long , void * , int  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetNormalHints XSetNormalHints a u a -- n", "FUNCTION: XSetNormalHints (    -- n )", "EXTERN: \"C\" int XSetNormalHints( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetRGBColormaps XSetRGBColormaps a u a n u -- void", "FUNCTION: XSetRGBColormaps (      -- void )", "EXTERN: \"C\" void XSetRGBColormaps( void * , long , void * , int , long  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetSizeHints XSetSizeHints a u a u -- n", "FUNCTION: XSetSizeHints (     -- n )", "EXTERN: \"C\" int XSetSizeHints( void * , long , void * , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetStandardProperties XSetStandardProperties a u a a u a n a -- n", "FUNCTION: XSetStandardProperties (         -- n )", "EXTERN: \"C\" int XSetStandardProperties( void * , long , char * , char * , long , void * , int , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetTextProperty XSetTextProperty a u a u -- void", "FUNCTION: XSetTextProperty (     -- void )", "EXTERN: \"C\" void XSetTextProperty( void * , long , void * , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWMClientMachine XSetWMClientMachine a u a -- void", "FUNCTION: XSetWMClientMachine (    -- void )", "EXTERN: \"C\" void XSetWMClientMachine( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWMHints XSetWMHints a u a -- n", "FUNCTION: XSetWMHints (    -- n )", "EXTERN: \"C\" int XSetWMHints( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWMIconName XSetWMIconName a u a -- void", "FUNCTION: XSetWMIconName (    -- void )", "EXTERN: \"C\" void XSetWMIconName( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWMName XSetWMName a u a -- void", "FUNCTION: XSetWMName (    -- void )", "EXTERN: \"C\" void XSetWMName( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWMNormalHints XSetWMNormalHints a u a -- void", "FUNCTION: XSetWMNormalHints (    -- void )", "EXTERN: \"C\" void XSetWMNormalHints( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWMProperties XSetWMProperties a u a a a n a a a -- void", "FUNCTION: XSetWMProperties (          -- void )", "EXTERN: \"C\" void XSetWMProperties( void * , long , void * , void * , void * , int , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XmbSetWMProperties XmbSetWMProperties a u a a a n a a a -- void", "FUNCTION: XmbSetWMProperties (          -- void )", "EXTERN: \"C\" void XmbSetWMProperties( void * , long , char * , char * , void * , int , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function Xutf8SetWMProperties Xutf8SetWMProperties a u a a a n a a a -- void", "FUNCTION: Xutf8SetWMProperties (          -- void )", "EXTERN: \"C\" void Xutf8SetWMProperties( void * , long , char * , char * , void * , int , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetWMSizeHints XSetWMSizeHints a u a u -- void", "FUNCTION: XSetWMSizeHints (     -- void )", "EXTERN: \"C\" void XSetWMSizeHints( void * , long , void * , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSetStandardColormap XSetStandardColormap a u a u -- void", "FUNCTION: XSetStandardColormap (     -- void )", "EXTERN: \"C\" void XSetStandardColormap( void * , long , void * , long  );", "	( <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XSetZoomHints XSetZoomHints a u a -- n", "FUNCTION: XSetZoomHints (    -- n )", "EXTERN: \"C\" int XSetZoomHints( void * , long , void *  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XWMGeometry XWMGeometry a n a a u a a a a a a -- n", "FUNCTION: XWMGeometry (            -- n )", "EXTERN: \"C\" int XWMGeometry( void * , int , char * , char * , int , void * , void * , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
