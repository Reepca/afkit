...
typedef struct {
  ...
  int y;	                 
	...
	swigFunction( "c-function XLoadFont XLoadFont a s -- u", "FUNCTION: XLoadFont (   -- u )", "EXTERN: \"C\" long XLoadFont( void * , char *  );", "	( <noname> <noname> -- )" );
	...
	swigFunction( "c-function XCreateBitmapFromData XCreateBitmapFromData a u s u u -- u", "FUNCTION: XCreateBitmapFromData (      -- u )", "EXTERN: \"C\" long XCreateBitmapFromData( void * , long , char * , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XStringToKeysym XStringToKeysym s -- u", "FUNCTION: XStringToKeysym (  -- u )", "EXTERN: \"C\" long XStringToKeysym( char *  );", "	( <noname> -- )" );
	...
	swigFunction( "c-function XAllocNamedColor XAllocNamedColor a u s a a -- n", "FUNCTION: XAllocNamedColor (      -- n )", "EXTERN: \"C\" int XAllocNamedColor( void * , long , char * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XDrawImageString XDrawImageString a u a n n s n -- n", "FUNCTION: XDrawImageString (        -- n )", "EXTERN: \"C\" int XDrawImageString( void * , long , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XDrawString XDrawString a u a n n s n -- n", "FUNCTION: XDrawString (        -- n )", "EXTERN: \"C\" int XDrawString( void * , long , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XLookupColor XLookupColor a u s a a -- n", "FUNCTION: XLookupColor (      -- n )", "EXTERN: \"C\" int XLookupColor( void * , long , char * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XParseColor XParseColor a u s a -- n", "FUNCTION: XParseColor (     -- n )", "EXTERN: \"C\" int XParseColor( void * , long , char * , void *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XQueryTextExtents XQueryTextExtents a u s n a a a a -- n", "FUNCTION: XQueryTextExtents (         -- n )", "EXTERN: \"C\" int XQueryTextExtents( void * , long , char * , int , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XReadBitmapFile XReadBitmapFile a u s a a a a a -- n", "FUNCTION: XReadBitmapFile (         -- n )", "EXTERN: \"C\" int XReadBitmapFile( void * , long , char * , void * , void * , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSetIconName XSetIconName a u s -- n", "FUNCTION: XSetIconName (    -- n )", "EXTERN: \"C\" int XSetIconName( void * , long , char *  );", "	( <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XStoreName XStoreName a u s -- n", "FUNCTION: XStoreName (    -- n )", "EXTERN: \"C\" int XStoreName( void * , long , char *  );", "	( <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XStoreNamedColor XStoreNamedColor a u s u n -- n", "FUNCTION: XStoreNamedColor (      -- n )", "EXTERN: \"C\" int XStoreNamedColor( void * , long , char * , long , int  );", "	( <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XWriteBitmapFile XWriteBitmapFile a s u u u n n -- n", "FUNCTION: XWriteBitmapFile (        -- n )", "EXTERN: \"C\" int XWriteBitmapFile( void * , char * , long , int , int , int , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XmbDrawString XmbDrawString a u a a n n s n -- void", "FUNCTION: XmbDrawString (         -- void )", "EXTERN: \"C\" void XmbDrawString( void * , long , void * , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function Xutf8DrawString Xutf8DrawString a u a a n n s n -- void", "FUNCTION: Xutf8DrawString (         -- void )", "EXTERN: \"C\" void Xutf8DrawString( void * , long , void * , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function XmbDrawImageString XmbDrawImageString a u a a n n s n -- void", "FUNCTION: XmbDrawImageString (         -- void )", "EXTERN: \"C\" void XmbDrawImageString( void * , long , void * , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function Xutf8DrawImageString Xutf8DrawImageString a u a a n n s n -- void", "FUNCTION: Xutf8DrawImageString (         -- void )", "EXTERN: \"C\" void Xutf8DrawImageString( void * , long , void * , void * , int , int , char * , int  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSaveContext XSaveContext a u n s -- n", "FUNCTION: XSaveContext (     -- n )", "EXTERN: \"C\" int XSaveContext( void * , long , int , char *  );", "	( <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XSetStandardProperties XSetStandardProperties a u s s u a n a -- n", "FUNCTION: XSetStandardProperties (         -- n )", "EXTERN: \"C\" int XSetStandardProperties( void * , long , char * , char * , long , void * , int , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	...
	swigFunction( "c-function XmbSetWMProperties XmbSetWMProperties a u s s a n a a a -- void", "FUNCTION: XmbSetWMProperties (          -- void )", "EXTERN: \"C\" void XmbSetWMProperties( void * , long , char * , char * , void * , int , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
	swigFunction( "c-function Xutf8SetWMProperties Xutf8SetWMProperties a u s s a n a a a -- void", "FUNCTION: Xutf8SetWMProperties (          -- void )", "EXTERN: \"C\" void Xutf8SetWMProperties( void * , long , char * , char * , void * , int , void * , void * , void *  );", "	( <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> <noname> -- )" );
